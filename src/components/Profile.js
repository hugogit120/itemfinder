...
// El componente <ProfileteRoute /> recibe como argumento un objeto con las propiedades: isLoggedIn y el resto de las props, y además un componente en la key component

function ProfileRoute({ component: Component, isLoggedin, ...rest }) {
